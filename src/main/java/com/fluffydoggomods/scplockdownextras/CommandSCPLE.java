	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
		...
		if (scplecmd.equals("version")) {
			if (Reference.VERSION != null) {
				sender.sendMessage(new TextComponentString(TextFormatting.WHITE + "[SCP Lockdown Extras] " + TextFormatting.GOLD + "" + TextFormatting.BOLD + "VERSION: " + TextFormatting.RESET + "" + TextFormatting.UNDERLINE + Reference.VERSION));;
			} else {
				sender.sendMessage(new TextComponentString(TextFormatting.WHITE + "[SCP Lockdown Extras] " + TextFormatting.RED + TextFormatting.BOLD + "WAS UNABLE TO FIND VERSION"));
			}
		} else if (scplecmd.equals("discord")) {
			sender.sendMessage(new TextComponentString(TextFormatting.WHITE + "[SCP Lockdown Extras] " + TextFormatting.AQUA + TextFormatting.BOLD + "LINK: " + TextFormatting.RESET + TextFormatting.AQUA + "https://discord.gg/ajkqZhK/"));
			...
			for (int i = 0; i < commands.size(); i++) {
				sender.sendMessage(new TextComponentString(TextFormatting.BOLD + commands.get(i) + TextFormatting.RESET + TextFormatting.WHITE + " - " + commandDescriptions.get(i)));
			}
		} else {
			sender.sendMessage(new TextComponentString(TextFormatting.RED + scplecmd + " does not exist. Try 'scple commands' for a list of commands"));
		}
	}
}
